...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  "children": [
	    {
	      "type": "div",
	      "shown": function () {return this.showSlider},
	      "style": {
	        "position": "absolute",
	        "top": 0,
	        "left": 0,
	          ...
	          "children": [
	            {
	              "type": "div",
	              "repeat": {
	                "expression": function () {return this.imgList},
	                "value": "i"
	              },
	              "style": {
	                "width": 750,
	              ...
	              "children": [
	                {
	                  ...
	                  "attr": {
	                    "resize": "contain",
	                    "src": function () {return 'http://img.playalot.cn/' + (this.i)}
	                  },
	                  "events": {
	                    "click": "tapToHideSlider"
	                  }
	                }
	              ]
	            },
	            {
	              ...
	              "style": {
	                "top": function () {return this.height-50}
	              }
	            }
	          ]
	        }
	    ...
	    {
	      "type": "div",
	      "shown": function () {return this.showDetail},
	      "style": {
	        "position": "absolute",
	        "top": 0,
	        "zIndex": -1,
	          ...
	          "children": [
	            {
	              "type": "image",
	              "attr": {
	                "src": function () {return 'http://img.playalot.cn/' + (this.cover)},
	                "resize": "cover"
	              },
	              "style": {
	                "width": 750,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  ready: function ready() {},
	  methods: {
	    tapToShowSlider: function tapToShowSlider() {
	      this.showSlider = true;
	    },
	    tapToHideSlider: function tapToHideSlider() {
